...
- If a picture would make the findings clearer (how the swarm fanned out, how results relate, a breakdown or flow), or if they ask to diagram/visualize/chart something, call renderDiagram with a small Mermaid diagram. Don't diagram a plain short list.
